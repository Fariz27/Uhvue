<template>
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="main-panel">
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr v-for="(item, index) in petugas" v-bind:item="item" v-bind:index="index" v-bind:key="item.id">
                          <td>
                            {{item.email}}
                          </td>
                          <td>
                          ...
                          <td>
                            <a href="#" @click="showModal = true" class="btn btn-sm btn-info btn-icon-text" data-toggle="modal" data-target="#modalTatib">
        ...
        <div class="modal fade" id="modalTatib" tabindex="-1" role="dialog" aria-labelledby="ModalLabel">
